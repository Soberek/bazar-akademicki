"""
Django settings for Bazar Akademicki - Student Marketplace with Django Oscar.
"""
...
OSCAR_SHOP_NAME = 'Bazar Akademicki'
OSCAR_SHOP_TAGLINE = 'Studencki Marketplace'
...
# Login/Logout URLs (Oscar handles these)
